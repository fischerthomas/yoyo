...
// bug chrome position fixed obj && obj.tagName
...
Events.prototype.getMousePos2 = function(evt){
    return this.mousePos2;
};
...
Events.prototype.setMousePosition = function(evt){
    ...
    // without OffSet window.page Offset
    var mouseX = evt.clientX - this.getCanvasPos().left;
    var mouseY = evt.clientY - this.getCanvasPos().top;
...
Events.prototype.setMousePosition2 = function(evt){
    var that = this
    setTimeout(function(){

    // without OffSet window.page Offset
    var mouseX = evt.clientX - that.getCanvasPos().left;
    var mouseY = evt.clientY - that.getCanvasPos().top;

    /*
    // with OffSet window
    var mouseX = evt.clientX - that.getCanvasPos().left + window.pageXOffset;
    var mouseY = evt.clientY - that.getCanvasPos().top + window.pageYOffset;
    */
